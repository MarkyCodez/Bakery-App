...
class PopularProductsDetails extends StatefulWidget {
  ...
  const PopularProductsDetails({super.key, required this.popular});
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: value_6 == widget.popular["name"]
                          ? Color.fromRGBO(201, 229, 252, 1)
                          : Colors.white,
                      borderRadius: BorderRadius.circular(20),
                    ),
                    child: value_6 == widget.popular["name"]
                        ? Column(
                            children: [
                              BackdropFilter(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(widget.popular["weight"]),
                            ElevatedButton.icon(
                              onPressed: () {
                                Provider.of<StateManagement>(context,
                                        listen: false)
                                    .addItems(widget.popular);
